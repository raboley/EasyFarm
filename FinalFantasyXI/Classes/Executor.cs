    ...
    public class Executor
    {
        ...
        {            
            ...
            while (DateTime.Now < interval)
            {
                ...
                if (Math.Abs((float) (previous - _fface.Player.CastPercentEx)) > .5) return true;
                SendCommand(command);
        ...
        private bool MonitorCast()
        {
            ...
            {
                if (Math.Abs((float) (prior - _fface.Player.CastPercentEx)) < .5)
                {
            ...
            return Math.Abs((float) (prior - 100)) < .5;
        }
